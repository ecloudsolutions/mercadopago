...
class MP {
    ...
    */    
    ...
    public function payment_methods() {
        ...
        $payment_methods = MPRestClient::get("/sites/MLA/payment_methods?access_token=" . $access_token);
    ...
    public function payment_method($id) {
        ...
        $payment_methods = MPRestClient::get("/sites/MLA/payment_methods/" . $id . "/?access_token=" . $access_token);
        return $payment_methods;
    }
